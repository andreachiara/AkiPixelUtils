...
namespace nlohmann {
    ...
    void from_json(const json & j, akiJsonConvos::Welcome & x);
    void to_json(json & j, const akiJsonConvos::Welcome & x);
    ...
    inline void from_json(const json & j, akiJsonConvos::Welcome& x) {
        x.set_conversations(j.at("conversations").get<std::vector<akiJsonConvos::Conversation>>());
    }

    inline void to_json(json & j, const akiJsonConvos::Welcome & x) {
        j = json::object();
